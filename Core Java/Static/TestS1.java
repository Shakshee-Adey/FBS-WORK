...
class BankAccount
{
   ...
   BankAccount()                                 //default constractor
    ...
    BankAccount(int i,String h,double b)   //parameterized constructor
    {
    System.out.println("constructor called");
    ...
    static void SetInterestRate(double s)     //change here the code write static and remove this
    {
    interestRate=s;
    }                               //setter end here
...
class TestS1
{
  ...
  {
    BankAccount b1 = new BankAccount(1234,"shakshee",2000);
    b1.display();
    BankAccount b2 = new BankAccount(12345,"prachi",3000);
    b2.display();
    BankAccount b3 = new BankAccount(1236,"rasu",4000);
    b3.display();
