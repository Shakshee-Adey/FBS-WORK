...
class TestDevice
{
   public static void main(String[] args) {
		...
		Laptop l2 = new Laptop("HP", "Pavilion", 65000, 16, 512);
		l2.display();
		System.out.println("\n");
		...
		Mobile m2 = new Mobile("Samsung", "Galaxy S24", 85000, 108, 5000);
		m2.display();
		System.out.println("\n");
		...
		SmartWatch s2 = new SmartWatch("Apple", "Watch", 45000, "AMOLED", 18);
		s2.display();
