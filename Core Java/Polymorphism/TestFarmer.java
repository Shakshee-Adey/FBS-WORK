...
class TestFarmer
{
	public static void main(String[] args) {
                ...
                Farmer f1 = new Farmer(501,"Roop","Warashivni",12000,7,1500,5);
		f1.display();
		System.out.println("\n");

		f1 = new DairyFarmer(501,"Shakshee","Balaghat",1200000,7,15000,5.3,7890,19,150);
		f1.display();
		System.out.println("\n");

		
                f1 = new PoultryFarmer(502,"vani","Shivni",95000,4,11000,6.7,300,380,5);
		f1.display();
		System.out.println("\n");
		
		
		
		f1 = new OrganicFarmer(503,"Bharti","Chindwara",11900,2,11000,4.2,9087,"Yuriya");
		f1.display();
