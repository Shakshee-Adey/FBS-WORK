...
class TestDefence{
	...
	public static void main(String[]args) {
                ...
                Defence d1 = new Defence("prchu",48000,"India","New Delhi", 6200,15,500);
                d1.display();
		d1 = new army("Rasu",48000,"India","New Delhi", 6200,15,500,4600, 25000,75000, 270);
                d1.display();
		d1 = new Navy("Vani",300,"India","New Delhi",950,12,150,150,16,500);
		d1.display();
	}
}