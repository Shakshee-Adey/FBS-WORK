...
class TestSalesManager
{
  public static void main(String[] args)
  {
    ...
    System.out.println("Enter SalesManager sid :- ");
    int sid = sc.nextInt();
    sc.nextLine();
    System.out.println("Enter SalesManager sname :- ");
    ...
    SalesManager b1 = new SalesManager(sid,sname,salary,incentive,target);
    b1.display();
   }// main ends here
